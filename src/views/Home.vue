        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde pequeñas empresas familiares hasta grandes multinacionales, las organizaciones son el corazón de la economía y la sociedad. La teoría organizacional surge como una herramienta indispensable para entender y mejorar estas estructuras, proporcionando un marco de referencia para su diseño, funcionamiento y adaptación a un entorno cambiante. 
              
              p #[b ¡Prepárese para transformar su visión sobre las organizaciones y desarrollar habilidades clave para la gestión efectiva!]
